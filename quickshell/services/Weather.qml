...
Singleton {
    ...
    function getWeatherUrl(): string {
        ...
        const params = ["latitude=" + lat, "longitude=" + lon, "models=meteoswiss_icon_ch2", "hourly=weather_code,temperature_2m", "daily=weather_code,temperature_2m_max,temperature_2m_min,sunrise,sunset", "current=temperature_2m,relative_humidity_2m,apparent_temperature,is_day,weather_code,wind_speed_10m", "timezone=auto", "forecast_days=5"];
